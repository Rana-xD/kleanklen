...
@php
   ...
   // if (Auth::user()->type == 'Owner') {
    ...
    if($setting['storage_setting'] == 'wasabi' || $setting['storage_setting'] == 's3'){
        $logo = \App\Models\Utility::get_file('uploads/logo');
    }
    ...
    $color_setting = App\Models\Utility::colorset();
    $color = 'theme-3';
    if (!empty($color_setting['color'])) {
                                                                ...
                                                                {{-- <img src="{{ $logo . '/' . (isset($logo_dark) && !empty($logo_dark) ? $logo_dark : ' logo-dark.png') }}"
                                                                    ...
                                                                    <a href="{{route('dashboard')}}" class="b-brand">
                                                                        <img src="{{ $logo . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-dark.png') . '?timestamp='. time() }}"
                                                                          alt="{{ config('app.name', 'Storego') }}" alt="logo" class="logo logo-lg nav-sidebar-logo fix-logo" id="adminlogoDark">
                                                                        </a>
                                                            </div>
                                                            ...
                                                            <div class=" setting-card">
                                                                <div class="logo-content mt-3">
                                                                    ...
                                                                    <a href="{{$s_logo.(isset($store_settings['logo']) && !empty($store_settings['logo'])? $store_settings['logo']:'logo.png')}}" target="_blank">
                                                                        <img id="StorelogoOwner" alt="your image" src="{{$s_logo.(isset($store_settings['logo']) && !empty($store_settings['logo'])? $store_settings['logo']:'logo.png') . '?timestamp='. time()}}"  class="big-logo invoice_logo img_setting" id="storeLogo">
                                                                    </a>
                                                                </div>
                                                            ...
                                                            <div class=" setting-card">
                                                                <div class="logo-content mt-3">
                                                                    ...
                                                                    <a href="{{$s_logo.(isset($store_settings['invoice_logo']) && !empty($store_settings['invoice_logo'])? $store_settings['invoice_logo']:'invoice_logo.png')}}" target="_blank">
                                                                        <img id="invoiceOwner" alt="your image" src="{{$s_logo.(isset($store_settings['invoice_logo']) && !empty($store_settings['invoice_logo'])? $store_settings['invoice_logo']:'invoice_logo.png') . '?timestamp='. time() }}" width="150px" class="big-logo invoice_logo img_setting" id="invoiceLogo">
                                                                    </a>
                                                                </div>
                                                                <div class="choose-files mt-4">
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="{{ isset($setting['NOCAPTCHA_SITEKEY']) ? $setting['NOCAPTCHA_SITEKEY'] : '' }}" id="google_recaptcha_key">
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4 form-group">
                                                ...
                                                <input class="form-control "
                                                    ...
                                                    value="{{ isset($setting['NOCAPTCHA_SECRET']) ? $setting['NOCAPTCHA_SECRET'] : '' }}" id="google_recaptcha_secret">
                                            </div>
                                        </div>
                            ...
                            <div class="card">
                                ...
                                {{Form::model($settings,array('route'=>'cookie.setting','method'=>'post'))}}
                                    ...
                                    <div class="card-body cookieDiv {{ $settings['enable_cookie'] == 'off' ? 'disabledCookie ' : '' }}">
                                        @if($setting['enable_chatgpt'] == 'on' && $settings['enable_cookie'] == 'on')
                                            <div class="d-flex justify-content-end">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" data-toggle="switchbutton" data-onstyle="primary" name="enable_chatgpt" class="form-check-input input-primary "
                                                    id="enable_chatgpt" {{ $settings['enable_chatgpt'] == 'on' ? ' checked ' : '' }} >
