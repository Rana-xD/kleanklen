                ...
                <div class="col-md-6  col-12 pdp-col-left ">
                    <div class="pdp-summery">
                        ...
                        <div class="wish-ratting d-flex justify-content-between">
                            ...
                            @if (Auth::guard('customers')->check())
                                @if (!empty($wishlist) && isset($wishlist[$products->id]['product_id']))
                                    ...
                                    @else
                                        <a href="#" class="btn wishlist-btn" data-id="{{ $products->id }}"><i class="fas fa-heart"></i></a>
                                    @endif
                                @else
                        ...
                        <div class="cart-price d-flex align-items-center product-price">
                            ...
                            <a href="#" data-id="{{ $products->id }}" class="btn add_to_cart">{{ __('Add to cart') }} <i class="fas fa-shopping-basket"></i></a>
                        </div>
                    ...
                    <div class="col-lg-6 col-12">
                        ...
                        <div class="customer-product-review">
                            ...
                            <div class="review-btn-star d-flex align-items-center">
                                ...
                                @if (Auth::guard('customers')->check())
                                    <a href="#" class="btn btn-icon" data-ajax-popup="true" data-title="{{ __('Create New Rating') }}"  data-url="{{ route('rating', [$store->slug, $products->id]) }}" data-size="lg" data-toggle="modal"><i class="fas fa-plus"></i></a>
                                @endif
                            </div>
                        </div>
