...
@section('action-btn')
    <div class="pr-2">
        @if($settings['enable_chatgpt'] == 'on')
            <a href="#" class="btn btn-primary mt-2" data-size="lg" data-ajax-popup-over="true" data-url="{{ route('generate',['products']) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Generate') }}" data-title="{{ __('Generate Content With AI') }}">
                <i class="fas fa-robot"></i> {{ __('Generate with AI') }}
            </a>
        @endif
        <a href="{{ route('product.index') }}" class="btn btn-light-secondary me-3 mt-2"> <i data-feather="x-circle"
                class="me-2"></i>{{ __('Cancel') }}</a>
        <a href="#" type="submit" id="submit-all" class="btn btn-success mt-2"> <i data-feather="check-circle"
