...
<div class="pr-2">
    ...
    @endcan
    @can('Create Products')
    <a class="btn btn-sm btn-icon  btn-success me-2" href="{{ route('product.create') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Create') }}">
                        ...
                        <tbody>
                            @foreach ($products as $product)
                                <tr>
                                    ...
                                    <td>
                                        @if ($product->enable_product_variant == 'on')
                                        <span class="badge rounded p-2 f-w-600  bg-light-success">{{ __('In Variant') }}</span>
                                        @else
                                            @if ($product->quantity == 0)
                                                <span class="badge rounded p-2 f-w-600  bg-light-danger">  {{ __('Out of stock') }}</span>
                                            @else
                                                <span class="badge rounded p-2 f-w-600  bg-light-success"> {{ __('In stock') }}</span>
                                            @endif
                                        @endif
