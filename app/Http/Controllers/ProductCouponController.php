            ...
            if(!empty($coupons))
            {
                ...
                else
                {
                    ...
                    if(!empty($request->shipping_price))
                    {
                        ...
                        $price            = self::formatPrice((float)$requestprice - $discount_value + str_replace(',','',$shipping_price), $request->store_id);
                        $data_value_price = $requestprice - floor($discount_value) + str_replace(',','',$shipping_price);
                    }
                    else
                    {
