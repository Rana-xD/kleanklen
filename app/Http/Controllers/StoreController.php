...
class StoreController extends Controller
{
    ...
    public function storeSlug($slug)
    {
        ...
        if (!empty($store)) {
            ...
            return view('storefront.' . $store->theme_dir . '.index', compact('mostPurchasedDetail','theme3_product_random', 'blogs', 'theme3_product_image', 'theme3_product', 'theme6_product_random', 'wishlist', 'products', 'settings', 'store', 'categories', 'total_item', 'page_slug_urls', 'blog', 'pro_categories', 'topRatedProducts', 'product_count', 'getStoreThemeSetting', 'getStoreThemeSetting1', 'theme7_product', 'theme7_product_image','theme7_product_byId','mostPurchased','latestProduct','theme9_product_random','latest2category','latestProduct10','pixelScript'));
